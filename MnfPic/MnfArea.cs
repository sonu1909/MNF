...
namespace MnfPic
{
    public static class MnfArea
    {
        ...
        {                                                         
            ...
            new MnfLocation("Wild West / Motel / Block D",new Point(1306.3,490.9),1600000000),
            new MnfLocation("Wild West / Motel / Block E",new Point(1306.3,490.9),1700000000),
            new MnfLocation("Wild West / Motel / Block A / Room",new Point(520.95,361),1800000000),
            new MnfLocation("Wild West / Motel / Block B / Room",new Point(520.95,361),1900000000),
            new MnfLocation("Wild West / Motel / Block C / Room",new Point(520.95,361),2000000000),
            new MnfLocation("Wild West / Motel / Block D / Room",new Point(520.95,361),2100000000),
            new MnfLocation("Wild West / Motel / Block E / Room",new Point(520.95,361),2200000000),
            new MnfLocation("Sacred Mountain / Sexual Wisdom Temple",new Point(616.15,823.2),2300000000),
            new MnfLocation("Wild West / Saloon / Cabaret",new Point(1068,704.2),2400000000),
            new MnfLocation("Meadows Park",new Point(736.15,668.7),2500000000),
            new MnfLocation("Meadows Park / Museum of Sex Art",new Point(613.9,1063.5),2600000000),
            new MnfLocation("Meadows Park / Museum of Sex Art / Recent Exposition 1",new Point(165.25,498.4),2700000000),
            new MnfLocation("Meadows Park / Museum of Sex Art / Recent Exposition 2",new Point(165.25,498.4),2800000000),
            new MnfLocation("Meadows Park / Museum of Sex Art / Recent Exposition 3",new Point(165.25,498.4),2900000000),
            new MnfLocation("Meadows Park / Museum of Sex Art / Recent Exposition 4",new Point(165.25,498.4),3000000000),
            new MnfLocation("Meadows Park / Museum of Sex Art / Weekly Best",new Point(165.25,498.4),3100000000),
            ...
            new MnfLocation("MnF Metropolis / Hotel Plaza",new Point(410.1,723.15),3900000000),
            new MnfLocation("MnF Metropolis / Hotel Plaza 2nd floor",new Point(153.3,520.15),4000000000),
            new MnfLocation("MnF Metropolis / Hotel Plaza 3rd floor",new Point(153.3,520.15),4100000000),
            new MnfLocation("MnF Metropolis / Hotel Plaza 4rd floor",new Point(153.3,520.15),4200000000),
            new MnfLocation("MnF Metropolis / Hotel Plaza 5rd floor",new Point(153.3,520.15),4300000000),
            new MnfLocation("MnF Metropolis / Hotel Plaza 6rd floor",new Point(153.3,520.15),4400000000),
            new MnfLocation("MnF Metropolis / Hotel Plaza 7th floor(VIP)",new Point(153.3,520.15),4500000000),
            new MnfLocation("MnF Metropolis / Hotel Plaza 2nd floor / Room",new Point(793.75,364),4600000000),
            new MnfLocation("MnF Metropolis / Hotel Plaza 3nd floor / Room",new Point(793.75,364),4700000000),
            new MnfLocation("MnF Metropolis / Hotel Plaza 4nd floor / Room",new Point(793.75,364),4800000000),
            new MnfLocation("MnF Metropolis / Hotel Plaza 5nd floor / Room",new Point(793.75,364),4900000000),
            new MnfLocation("MnF Metropolis / Hotel Plaza 6nd floor / Room",new Point(793.75,364),5000000000),
            new MnfLocation("MnF Metropolis / Hotel Plaza 7th floor / President Lux",new Point(1141.55,460.25),5100000000),
            new MnfLocation("MnF Metropolis / Hotel Plaza 8th floor / President Lux",new Point(1141.55,460.25),5200000000),
            new MnfLocation("MnF Metropolis / Hotel Plaza 8th floor(VIP)",new Point(153.3,520.15),5300000000),
            new MnfLocation("Red Heat",new Point(599.9,1117),5400000000),
            new MnfLocation("Red Heat / Bar Vodka",new Point(1059.8,606.05),5500000000),
            new MnfLocation("Shooting Gallery",new Point(606.7,980.8),5600000000),
            new MnfLocation("Oasis",new Point(648.9,900.35),5700000000),
            new MnfLocation("Oasis / Baths",new Point(475.2,784.45),5800000000),
            new MnfLocation("Oasis / Casino",new Point(437.35,872.5),5900000000),
